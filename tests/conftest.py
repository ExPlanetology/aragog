...
class Helper:
    ...
    Args:
        atol: Absolute tolerance for passing tests. Defaults to 1.0e-6.
        rtol: Relative tolerance for passing tests Defaults to 1.0e-6.
    ...
    def __init__(self, atol: float = 1.0e-6, rtol: float = 1.0e-6):
